...
<template>
  <el-card class="box-card">
        ...
        <div>
          ...
          <div>
            ...
            <div class="header-bar-right">
                <el-button type="primary"  @click="createDialogVisible = true"><el-icon><plus /></el-icon>&nbsp;机房创建</el-button>
      ...
      >
        ...
        <el-table-column prop="name" label="机房名称" width="180" v-if="showColumn.name" sortable/>
        <el-table-column prop="city" label="城市" width="180"  v-if="showColumn.city" sortable/>
        <el-table-column prop="provider" label="运营商"  v-if="showColumn.provider" sortable/>
